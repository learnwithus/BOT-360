...
<iframe id="iframe" src="http://vchdesign.ca/BOT-360/vgh.html"></iframe>
...
<?php
  for ($i = 1; $i < 18; $i++) {
      echo '<link rel="prefetch" href="http://vchdesign.ca/BOT-360/assets/vgh/vgh' . $i . '.jpg">';
  }
?>
